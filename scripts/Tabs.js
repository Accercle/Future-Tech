...
class Tabs {
    ...
    constructor(rootElement) {
        ...
        this.listTabsIndex = this.buttonElements.length - 1
        this.bindEvents()
    }
    ...
    updateUI() {
        ...
        this.buttonElements.forEach((buttonElement, index) => {
          ...
          buttonElement.stateAttributes(this.stateAttributes.ariaSelected, isActive.toString())
          buttonElement.stateAttributes(this.stateAttributes.tabIndex, isActive ? 0 : '-1')
        })
